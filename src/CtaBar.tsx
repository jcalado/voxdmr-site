...
const SEGMENT = "btn-press inline-flex items-center justify-center gap-2.5 rounded-full text-base px-6 py-4 transition-colors whitespace-nowrap";
...
export function CtaBar({ className = "" }: CtaBarProps) {
  ...
  return (
    ...
    >
      ...
      <a href={RELEASES_URL} target="_blank" rel="noopener noreferrer" className={`${SEGMENT} bg-slate-700 hover:bg-slate-600 text-white font-bold`}>
