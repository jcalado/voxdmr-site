...
function BoolCell({ value, t }: { value: Support; t: TFn }) {
  if (value === "yes")
    return (
...
function ScoreMeter({ radio, score, t }: { radio: Radio; score: number; t: TFn }) {
...
export default function RadiosGrid({ lang }: RadiosGridProps) {
  const t = getT(lang);
